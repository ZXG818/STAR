...
!****************************************************************************
  ...
  do iter=1, MAX_ITER
    ...
    call SolveFirstDirection(mesh_group,  REFLECTIVE_BOUND, -1.d0, REFLECTIVE_BOUND, -1.d0)
    call SolveSecondDirection(mesh_group, REFLECTIVE_BOUND, -1.d0, REFLECTIVE_BOUND, -1.d0)
    call SolveThirdDirection(mesh_group,  REFLECTIVE_BOUND, -1.d0, REFLECTIVE_BOUND, -1.d0)
    call SolveFourthDirection(mesh_group, REFLECTIVE_BOUND, -1.d0, REFLECTIVE_BOUND, -1.d0)
