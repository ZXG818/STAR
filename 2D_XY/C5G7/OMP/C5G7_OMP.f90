...
!****************************************************************************
  ...
  ! 7.0% MOX fuel, color = 5
  ! group 1
  group_constant(5,1)%sigma_t   =1.81323E-01
  group_constant(5,1)%sigma_f   =8.25446E-03
  group_constant(5,1)%Nu        =2.88498E+00
  group_constant(5,1)%Xf        =5.87910E-01
  group_constant(5,1)%sigma_s(1)=1.30457E-01
  group_constant(5,1)%sigma_s(2)=4.17920E-02
  group_constant(5,1)%sigma_s(3)=8.51050E-06
  group_constant(5,1)%sigma_s(4)=5.13290E-09
  group_constant(5,1)%sigma_s(5)=0.d0
  group_constant(5,1)%sigma_s(6)=0.d0
  group_constant(5,1)%sigma_s(7)=0.d0
  ! group 2
  group_constant(5,2)%sigma_t   =3.34368E-01
  group_constant(5,2)%sigma_f   =1.32565E-03
  group_constant(5,2)%Nu        =2.91079E+00
  group_constant(5,2)%Xf        =4.11760E-01
  group_constant(5,2)%sigma_s(1)=0.d0
  group_constant(5,2)%sigma_s(2)=3.28428E-01
  group_constant(5,2)%sigma_s(3)=1.64360E-03
  group_constant(5,2)%sigma_s(4)=2.20170E-09
  group_constant(5,2)%sigma_s(5)=0.d0
  group_constant(5,2)%sigma_s(6)=0.d0
  group_constant(5,2)%sigma_s(7)=0.d0
  ! group 3
  group_constant(5,3)%sigma_t   =4.93785E-01
  group_constant(5,3)%sigma_f   =8.42156E-03
  group_constant(5,3)%Nu        =2.86574E+00
  group_constant(5,3)%Xf        =3.39060E-04
  group_constant(5,3)%sigma_s(1)=0.d0
  group_constant(5,3)%sigma_s(2)=0.d0
  group_constant(5,3)%sigma_s(3)=4.58371E-01
  group_constant(5,3)%sigma_s(4)=2.53310E-03
  group_constant(5,3)%sigma_s(5)=0.d0
  group_constant(5,3)%sigma_s(6)=0.d0
  group_constant(5,3)%sigma_s(7)=0.d0
  ! group 4
  group_constant(5,4)%sigma_t   =5.91216E-01
  group_constant(5,4)%sigma_f   =3.28730E-02
  group_constant(5,4)%Nu        =2.87063E+00
  group_constant(5,4)%Xf        =1.17610E-07
  group_constant(5,4)%sigma_s(1)=0.d0
  group_constant(5,4)%sigma_s(2)=0.d0
  group_constant(5,4)%sigma_s(3)=0.d0
  group_constant(5,4)%sigma_s(4)=4.63709E-01
  group_constant(5,4)%sigma_s(5)=5.47660E-03
  group_constant(5,4)%sigma_s(6)=0.d0
  group_constant(5,4)%sigma_s(7)=0.d0
  ! group 5
  group_constant(5,5)%sigma_t   =4.74198E-01
  group_constant(5,5)%sigma_f   =1.59636E-02
  group_constant(5,5)%Nu        =2.86714E+00
  group_constant(5,5)%Xf        =0.d0
  group_constant(5,5)%sigma_s(1)=0.d0
  group_constant(5,5)%sigma_s(2)=0.d0
  group_constant(5,5)%sigma_s(3)=0.d0
  group_constant(5,5)%sigma_s(4)=1.76190E-04
  group_constant(5,5)%sigma_s(5)=2.82313E-01
  group_constant(5,5)%sigma_s(6)=8.72890E-03
  group_constant(5,5)%sigma_s(7)=9.00160E-09
  ! group 6
  group_constant(5,6)%sigma_t   =8.33601E-01
  group_constant(5,6)%sigma_f   =3.23794E-01
  group_constant(5,6)%Nu        =2.86658E+00
  group_constant(5,6)%Xf        =0.d0
  group_constant(5,6)%sigma_s(1)=0.d0
  group_constant(5,6)%sigma_s(2)=0.d0
  group_constant(5,6)%sigma_s(3)=0.d0
  group_constant(5,6)%sigma_s(4)=0.d0
  group_constant(5,6)%sigma_s(5)=2.27600E-03
  group_constant(5,6)%sigma_s(6)=2.49751E-01
  group_constant(5,6)%sigma_s(7)=1.31140E-02
  ! group 7
  group_constant(5,7)%sigma_t   =8.53603E-01
  group_constant(5,7)%sigma_f   =3.62803E-01
  group_constant(5,7)%Nu        =2.87539E+00
  group_constant(5,7)%Xf        =0.d0
  group_constant(5,7)%sigma_s(1)=0.d0
  group_constant(5,7)%sigma_s(2)=0.d0
  group_constant(5,7)%sigma_s(3)=0.d0
  group_constant(5,7)%sigma_s(4)=0.d0
  group_constant(5,7)%sigma_s(5)=0.d0
  group_constant(5,7)%sigma_s(6)=8.86450E-03
  group_constant(5,7)%sigma_s(7)=2.59529E-01
  
  ! 4.3% MOX fuel, color = 6
  ! group 1
  group_constant(6,1)%sigma_t   =1.78731E-01
  group_constant(6,1)%sigma_f   =7.62704E-03
  group_constant(6,1)%Nu        =2.85209E+00
  group_constant(6,1)%Xf        =5.87910E-01
  group_constant(6,1)%sigma_s(1)=1.28876E-01
  group_constant(6,1)%sigma_s(2)=4.14130E-02
  group_constant(6,1)%sigma_s(3)=8.22900E-06
  group_constant(6,1)%sigma_s(4)=5.04050E-09
  group_constant(6,1)%sigma_s(5)=0.d0
  group_constant(6,1)%sigma_s(6)=0.d0
  group_constant(6,1)%sigma_s(7)=0.d0
  ! group 2
  group_constant(6,2)%sigma_t   =3.30849E-01
  group_constant(6,2)%sigma_f   =8.76898E-04
  group_constant(6,2)%Nu        =2.89099E+00
  group_constant(6,2)%Xf        =4.11760E-01
  group_constant(6,2)%sigma_s(1)=0.d0
  group_constant(6,2)%sigma_s(2)=3.25452E-01
  group_constant(6,2)%sigma_s(3)=1.63950E-03
  group_constant(6,2)%sigma_s(4)=1.59820E-09
  group_constant(6,2)%sigma_s(5)=0.d0
  group_constant(6,2)%sigma_s(6)=0.d0
  group_constant(6,2)%sigma_s(7)=0.d0
  ! group 3
  group_constant(6,3)%sigma_t   =4.83772E-01
  group_constant(6,3)%sigma_f   =5.69835E-03
  group_constant(6,3)%Nu        =2.85486E+00
  group_constant(6,3)%Xf        =3.39060E-04
  group_constant(6,3)%sigma_s(1)=0.d0
  group_constant(6,3)%sigma_s(2)=0.d0
  group_constant(6,3)%sigma_s(3)=4.53188E-01
  group_constant(6,3)%sigma_s(4)=2.61420E-03
  group_constant(6,3)%sigma_s(5)=0.d0
  group_constant(6,3)%sigma_s(6)=0.d0
  group_constant(6,3)%sigma_s(7)=0.d0
  ! group 4
  group_constant(6,4)%sigma_t   =5.66922E-01
  group_constant(6,4)%sigma_f   =2.28872E-02
  group_constant(6,4)%Nu        =2.86073E+00
  group_constant(6,4)%Xf        =1.17610E-07
  group_constant(6,4)%sigma_s(1)=0.d0
  group_constant(6,4)%sigma_s(2)=0.d0
  group_constant(6,4)%sigma_s(3)=0.d0
  group_constant(6,4)%sigma_s(4)=4.57173E-01
  group_constant(6,4)%sigma_s(5)=5.53940E-03
  group_constant(6,4)%sigma_s(6)=0.d0
  group_constant(6,4)%sigma_s(7)=0.d0
  ! group 5
  group_constant(6,5)%sigma_t   =4.26227E-01
  group_constant(6,5)%sigma_f   =1.07635E-02
  group_constant(6,5)%Nu        =2.85447E+00
  group_constant(6,5)%Xf        =0.d0
  group_constant(6,5)%sigma_s(1)=0.d0
  group_constant(6,5)%sigma_s(2)=0.d0
  group_constant(6,5)%sigma_s(3)=0.d0
  group_constant(6,5)%sigma_s(4)=1.60460E-04
  group_constant(6,5)%sigma_s(5)=2.76814E-01
  group_constant(6,5)%sigma_s(6)=9.31270E-03
  group_constant(6,5)%sigma_s(7)=9.16560E-09
  ! group 6
  group_constant(6,6)%sigma_t   =6.78997E-01
  group_constant(6,6)%sigma_f   =2.32757E-01
  group_constant(6,6)%Nu        =2.86415E+00
  group_constant(6,6)%Xf        =0.d0
  group_constant(6,6)%sigma_s(1)=0.d0
  group_constant(6,6)%sigma_s(2)=0.d0
  group_constant(6,6)%sigma_s(3)=0.d0
  group_constant(6,6)%sigma_s(4)=0.d0
  group_constant(6,6)%sigma_s(5)=2.00510E-03
  group_constant(6,6)%sigma_s(6)=2.52962E-01
  group_constant(6,6)%sigma_s(7)=1.48500E-02
  ! group 7
  group_constant(6,7)%sigma_t   =6.82852E-01
  group_constant(6,7)%sigma_f   =2.48968E-01
  group_constant(6,7)%Nu        =2.86780E+00
  group_constant(6,7)%Xf        =0.d0
  group_constant(6,7)%sigma_s(1)=0.d0
  group_constant(6,7)%sigma_s(2)=0.d0
  group_constant(6,7)%sigma_s(3)=0.d0
  group_constant(6,7)%sigma_s(4)=0.d0
  group_constant(6,7)%sigma_s(5)=0.d0
  group_constant(6,7)%sigma_s(6)=8.49480E-03
  group_constant(6,7)%sigma_s(7)=2.65007E-01
  
  ! 8.7% MOX fuel, color = 7
  ! group 1
  group_constant(7,1)%sigma_t   =1.83045E-01
  group_constant(7,1)%sigma_f   =8.67209E-03
  group_constant(7,1)%Nu        =2.90426E+00
  group_constant(7,1)%Xf        =5.87910E-01
  group_constant(7,1)%sigma_s(1)=1.31504E-01
  group_constant(7,1)%sigma_s(2)=4.20460E-02
  group_constant(7,1)%sigma_s(3)=8.69720E-06
  group_constant(7,1)%sigma_s(4)=5.19380E-09
  group_constant(7,1)%sigma_s(5)=0.d0
  group_constant(7,1)%sigma_s(6)=0.d0
  group_constant(7,1)%sigma_s(7)=0.d0
  ! group 2
  group_constant(7,2)%sigma_t   =3.36705E-01
  group_constant(7,2)%sigma_f   =1.62426E-03
  group_constant(7,2)%Nu        =2.91795E+00
  group_constant(7,2)%Xf        =4.11760E-01
  group_constant(7,2)%sigma_s(1)=0.d0
  group_constant(7,2)%sigma_s(2)=3.30403E-01
  group_constant(7,2)%sigma_s(3)=1.64630E-03
  group_constant(7,2)%sigma_s(4)=2.60060E-09
  group_constant(7,2)%sigma_s(5)=0.d0
  group_constant(7,2)%sigma_s(6)=0.d0
  group_constant(7,2)%sigma_s(7)=0.d0
  ! group 3
  group_constant(7,3)%sigma_t   =5.00507E-01
  group_constant(7,3)%sigma_f   =1.02716E-02
  group_constant(7,3)%Nu        =2.86986E+00
  group_constant(7,3)%Xf        =3.39060E-04
  group_constant(7,3)%sigma_s(1)=0.d0
  group_constant(7,3)%sigma_s(2)=0.d0
  group_constant(7,3)%sigma_s(3)=4.61792E-01
  group_constant(7,3)%sigma_s(4)=2.47490E-03
  group_constant(7,3)%sigma_s(5)=0.d0
  group_constant(7,3)%sigma_s(6)=0.d0
  group_constant(7,3)%sigma_s(7)=0.d0
  ! group 4
  group_constant(7,4)%sigma_t   =6.06174E-01
  group_constant(7,4)%sigma_f   =3.90447E-02
  group_constant(7,4)%Nu        =2.87491E+00
  group_constant(7,4)%Xf        =1.17610E-07
  group_constant(7,4)%sigma_s(1)=0.d0
  group_constant(7,4)%sigma_s(2)=0.d0
  group_constant(7,4)%sigma_s(3)=0.d0
  group_constant(7,4)%sigma_s(4)=4.68021E-01
  group_constant(7,4)%sigma_s(5)=5.43300E-03
  group_constant(7,4)%sigma_s(6)=0.d0
  group_constant(7,4)%sigma_s(7)=0.d0
  ! group 5
  group_constant(7,5)%sigma_t   =5.02754E-01
  group_constant(7,5)%sigma_f   =1.92576E-02
  group_constant(7,5)%Nu        =2.87175E+00
  group_constant(7,5)%Xf        =0.d0
  group_constant(7,5)%sigma_s(1)=0.d0
  group_constant(7,5)%sigma_s(2)=0.d0
  group_constant(7,5)%sigma_s(3)=0.d0
  group_constant(7,5)%sigma_s(4)=1.85970E-04
  group_constant(7,5)%sigma_s(5)=2.85771E-01
  group_constant(7,5)%sigma_s(6)=8.39730E-03
  group_constant(7,5)%sigma_s(7)=8.92800E-09
  ! group 6
  group_constant(7,6)%sigma_t   =9.21028E-01
  group_constant(7,6)%sigma_f   =3.74888E-01
  group_constant(7,6)%Nu        =2.86752E+00
  group_constant(7,6)%Xf        =0.d0
  group_constant(7,6)%sigma_s(1)=0.d0
  group_constant(7,6)%sigma_s(2)=0.d0
  group_constant(7,6)%sigma_s(3)=0.d0
  group_constant(7,6)%sigma_s(4)=0.d0
  group_constant(7,6)%sigma_s(5)=2.39160E-03
  group_constant(7,6)%sigma_s(6)=2.47614E-01
  group_constant(7,6)%sigma_s(7)=1.23220E-02
  ! group 7
  group_constant(7,7)%sigma_t   =9.55231E-01
  group_constant(7,7)%sigma_f   =4.30599E-01
  group_constant(7,7)%Nu        =2.87808E+00
  group_constant(7,7)%Xf        =0.d0
  group_constant(7,7)%sigma_s(1)=0.d0
  group_constant(7,7)%sigma_s(2)=0.d0
  group_constant(7,7)%sigma_s(3)=0.d0
  group_constant(7,7)%sigma_s(4)=0.d0
  group_constant(7,7)%sigma_s(5)=0.d0
  group_constant(7,7)%sigma_s(6)=8.96810E-03
  group_constant(7,7)%sigma_s(7)=2.56093E-01
  return
  endsubroutine
  ! get the distance
...
!$  write(*, *) "1st direction, thread id=", omp_get_thread_num()
    call SolveFirstDirection(mesh_group, old_mesh_group, group_constant,    &
                             SPECIFIED_BOUND, 0.d0, REFLECTIVE_BOUND, -1.d0)
!$omp section
