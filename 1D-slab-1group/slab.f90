...
!****************************************************************************
    ...
    contains
    ! generate the grid
    subroutine Generate_grid(mesh_group, x_lower, x_upper)
    implicit none
    ...
    subroutine PowerIteration(mesh_group, old_mesh_group, &
                              SIGMA_T, SIGMA_S, external_source, x_lower, x_upper)
    implicit none
    type(meshtype), dimension(:, :), intent(inout) :: mesh_group
    ...
    x_cnt = size(mesh_group, 2)
    ! mesher
    call Generate_grid(mesh_group, x_lower, x_upper)
    ! initialize the macro-xs
    call MacroXS(mesh_group, x_lower, x_upper, SIGMA_T, SIGMA_S, external_source)
    ! initialize the field
    ...
    call PowerIteration(mesh_group, old_mesh_group, &
                        SIGMA_T, SIGMA_S, external_source, x_lower, x_upper)
